...
<html>
    ...
    <body>
        ...
        <div id="show-obraSocial" class="content scaffold-show" role="main">
            ...
            <f:display bean="obraSocial" />
            <g:form resource="${this.obraSocial}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.obraSocial}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
