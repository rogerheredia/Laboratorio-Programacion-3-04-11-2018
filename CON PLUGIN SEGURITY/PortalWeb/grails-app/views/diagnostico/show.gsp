...
<html>
    ...
    <body>
        ...
        <div id="show-diagnostico" class="content scaffold-show" role="main">
            ...
            <f:display bean="diagnostico" />
            <g:form resource="${this.diagnostico}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.diagnostico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
