...
<html>
    ...
    <body>
        ...
        <div id="show-especialidad" class="content scaffold-show" role="main">
            ...
            <f:display bean="especialidad" />
            <g:form resource="${this.especialidad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.especialidad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
