...
<html>
    ...
    <body>
        ...
        <div id="show-solicitante" class="content scaffold-show" role="main">
            ...
            <f:display bean="solicitante" />
            <g:form resource="${this.solicitante}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.solicitante}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
